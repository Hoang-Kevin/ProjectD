                ...
                <ul className={styles.navbarnav}>
                    <li className={styles.navitem}>
                        <div className={styles.navlink}>
                            <Link to="/profile"><img className={styles.roundedimg} src={user.picture} alt="Profile" />
                            <span className={styles.linktext}>{user.nickname}</span>
                            </Link>
                        </div>
                    </li>
                    <li className={styles.navitem}>
                    ...
                    <li className={styles.navitem}>
                        <div className={styles.navlink}>
                            <Link to="/COVIDApp">
                                ...
                                <span className={styles.linktext}>CovidAPP</span>
                            </Link>
                        </div>
                    </li>
                    <li className={styles.navitem}>
                        <div className={styles.navlink}>
                            <Link to="/Kanban">
                                ...
                                <span className={styles.linktext}>Kanban</span>
                            </Link>
                        </div>
                    </li>
                    <li className={styles.navitem}>
